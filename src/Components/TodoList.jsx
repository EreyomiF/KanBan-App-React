...
import CompletedIcon from '../assets/icons/jackpot.png';
import OldIcon from '../assets/icons/folder2.png';          // Use PNG or convert SVG to PNG or vice versa
...
function TodoList({ items, onDeleteTask }) {
  ...
  const categoryIcons = {
    ...
    Completed: 'bg-sky-300 text-white',
    Old: 'bg-lime-500 text-black',
  };
