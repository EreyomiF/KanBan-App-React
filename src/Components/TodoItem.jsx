  ...
  return (
    <>
          ...
          >
            ...
            <h5 className="mb-2 text-2xl font-bold tracking-tight mt-4 text-gray-900 dark:text-white">
              {task.title}
            </h5>
            ...
            <div className="relative bg-white rounded-2xl shadow-lg max-w-md w-full p-6 border border-gray-200 animate-fade-in">
              ...
              <div className="mb-4">
                <p className="text-gray-600">
                  <span className="font-semibold text-gray-800">Title:</span> {task.title}
                </p>
                <p className="text-gray-600 mt-2">
                  <span className="font-semibold text-gray-800">Description:</span> {task.description}
                </p>
                <p className="text-gray-600 mt-2">
                  <span className="font-semibold text-gray-800">Number:</span> {task.number}
                </p>
                <p className="mb-3">
